...
#define PORT_NUM_OF_CONFIGURED_CHANNLES		4

#define PortConf_LED1_CHANNEL_INDEX			0
#define PortConf_LED1_CHANNEL_ID			PORT_PIN_0
#define PortConf_LED1_PORT_ID				PORT_PORTA_ID
#define PortConf_LED1_DIRECTION				PORT_PIN_OUT
#define PortConf_LED1_INIT_VALUE			PORT_PIN_INITIAL_HIGH

#define PortConf_LED2_CHANNEL_INDEX			1
#define PortConf_LED2_CHANNEL_ID			PORT_PIN_1
#define PortConf_LED2_PORT_ID				PORT_PORTA_ID
